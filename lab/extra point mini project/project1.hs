...
--example of MaxHeap to test code
main :: IO ()
main = do
    -- Example of creating a MaxHeap
    let heap :: MaxHeap Int
        heap = [3, 1, 4, 1, 5, 9, 2, 6, 5, 3, 5]
    
    -- Example of percolateUp
    let heapAfterPercolateUp = percolateUp 7 heap
    putStrLn "Heap after percolateUp:"
    print heapAfterPercolateUp
    
    -- Example of percolateDown
    let heapAfterPercolateDown = percolateDown 1 heap
    putStrLn "Heap after percolateDown:"
    print heapAfterPercolateDown